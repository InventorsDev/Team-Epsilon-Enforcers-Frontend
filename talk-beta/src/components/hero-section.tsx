...
export function HeroSection() {
  return (
    <section className="min-h-screen flex items-center justify-center px-9 py-16">
        ...
        <div className="grid lg:grid-cols-2 items-center gap-12 h-full">
          <div className="space-y-6 w-full text-left">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              AI-Powered fluency coach designed to help you practice, improve,
              and master fluency. Practice in real time, and unlock the power of
              your voice.
            </p>
            <Button
              variant="outline"
