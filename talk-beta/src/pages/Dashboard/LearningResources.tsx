...
export default function LearningResourcesPage() {
  const [filter, setFilter] = useState<"All" | "Lesson" | "Article" | "Video">(
    "All"
  );
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 pb-10 bg-white">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-12">
          <div className="relative flex-1 w-full sm:w-auto">
            ...
            <Input
              ...
              className="pl-10 h-12 border-[#DEE1E6FF] rounded-[6px] w-full md:w-[448px]"
              value={search}
        ...
        {/* Call to Action */}
        <section className="text-center py-16 bg-white rounded-lg px-4 sm:px-8">
